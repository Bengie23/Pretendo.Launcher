...
dotnet run --configureation Release --property WarningLevel=0 #Requires -RunAsAdministrator
...
Set-Location .\backend
Write-Host "Running Backend..."
dotnet run --configureation Release --property WarningLevel=0  --launch-profile "nginx"